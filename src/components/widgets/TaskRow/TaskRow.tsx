...
export const TaskRow = ({ variant_id, name }: TaskRowProps) => {
  ...
  useEffect(() => {
    if (isSuccessVariant && variant.data.id) {
      tasks[variant.data.name as keyof TasksState].settings.updateId(variant.data.id)
    }
          ...
          <div className={styles.container}>
            <div className={styles.checkbox_question}>
              <Checkbox
                id={variant_id}
                checked={
                  tasks[name as keyof TasksState].settings.checked
                }
            ...
            {isSuccessVariant && ( <>
            {tasks[variant.data.name as keyof TasksState].settings.checked && (
